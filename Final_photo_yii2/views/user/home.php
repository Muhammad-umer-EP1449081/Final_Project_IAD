...
?>
            ...
            <p class="post-data"><span class="date"><?php echo $post->date?></span> &nbsp;|&nbsp; Posted by <a href="#" style="color:blue;"><?php echo $user->username ?></a> &nbsp;|&nbsp;Post Status <a href="#" style="color:blue;"><?php echo $post->p_status ?></a>
