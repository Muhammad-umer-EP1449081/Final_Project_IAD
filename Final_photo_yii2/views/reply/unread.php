...
$this->title = 'All unread Messages';
?>
...
<h2 class="page-header" style="text-color:white">Messages</h2>
...
<?php foreach($unseens as $unseen) : ?>


<?php if( !($unseen->user_id_message == Yii::$app->user->identity->id) ) : ?>
...
$user_message = User::find()->where(['user_id' => $unseen->user_id_message])->one();
$request_user_pic_message =  ProfilePicture::find()->where(['user_id'=>$user_message->user_id])->one();
...
?>
  ...
  <p class="post-data">
                 ...
                 <img src="images/<?php echo $request_user_pic_message->filename?>" width="70" height="70" alt="" />
    

                Message by <span style="color:blue;"><?php echo $user_message->username ?></span>
                &nbsp;|&nbsp;
               
               <span class="date" style="color:black;"><?php echo $unseen->message?></span>
                &nbsp;|&nbsp;

<a  class="btn btn-primary" style="color:white;" 
href="/Final_photo_yii2/web/index.php?r=reply/doread&id=<?php echo $unseen->cm_id ?>">
  Click to Reply</a>
             </p>
