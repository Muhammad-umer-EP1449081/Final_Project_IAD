...
class Profilepicture extends DatabaseObject {
	...
	protected static $table_name="profile_picture";
	protected static $db_fields=array('pp_id', 'user_id', 'filename', 'size', 'type');
	public $pp_id;
	public $user_id;
	public $filename;
	public $size;
  ...
  public static function find_by_sql_pp($sql="") 
  {
    global $database;
    $result_set = $database->querypp($sql);
    
  }

public static function find_by_sql_photograph($sql="") 
{
    global $database;

    $result_set = $database->query_photo($sql);
    print($result_set);
